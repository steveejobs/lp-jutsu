...
export function JutsuExperienceSelectorClient() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-[#070707] py-12 text-white md:py-20"
    >
      ...
      <div className="container-page relative z-10">
        ...
        <div className="mt-8 overflow-hidden rounded-lg border border-white/12 bg-[#0b0b0b] shadow-[0_34px_120px_rgba(0,0,0,0.52)] md:mt-10">
          <div className="grid md:min-h-[660px] md:grid-cols-[280px_1fr] lg:grid-cols-[300px_1fr]">
            <div className="border-b border-white/10 bg-[#0d0d0d] p-3 md:border-b-0 md:border-r md:p-4">
                ...
                {jutsuExperienceItems.map((item, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative shrink-0 rounded-full border px-4 py-3 text-left text-sm font-black transition duration-300 md:flex md:h-full md:w-full md:items-center md:rounded-none md:border-0 md:border-b md:border-white/8 md:py-0 md:pl-6 md:pr-4 md:text-base ${
                        isActive
            ...
            <div className="relative grid gap-0 md:grid-cols-[1.5fr_0.5fr]">
              <div className="relative h-[420px] overflow-hidden bg-black sm:h-[480px] md:h-auto md:min-h-full">
                <Image
              ...
              <div className="relative flex items-end overflow-hidden border-t border-white/10 bg-[#101010] p-5 md:min-h-0 md:border-l md:border-t-0 md:p-7 lg:p-9">
                <div
                  aria-hidden="true"
                ...
                >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="btn btn-primary mt-7 shadow-[0_20px_54px_rgba(216,58,36,0.38)]"
                  >
                    {activeItem.cta}
                  </a>
                </div>
